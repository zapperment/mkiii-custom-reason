...
function remote_prepare_for_use()
    ...
    return {remote.make_midi(sysexKnobLayout), create_knobs(0, color.no_color), create_knobs(1, color.no_color),
            create_knobs(2, color.no_color), create_knobs(3, color.no_color), create_knobs(4, color.no_color),
